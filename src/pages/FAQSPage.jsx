...
export default function FAQSPage() {
  ...
  const orderingFaqs = [
    ...
    },
    {
      ...
      answer: (
        <p>
          Surely, we do. Dimond Modern Furniture has partnered with several companies to
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            Dimond Modern Furniture has two locations in the Houston area, offering a
    ...
    },
    {
      ...
      icon: '⎔',
      question:
        'Why is Dimond Modern Furniture requesting additional information to fulfill my order?',
      answer: (
        <p>
  ...
  const shippingFaqs = [
    ...
    },
    {
      ...
      answer: (
        <p>
            Dimond Modern Furniture will not take your old furniture or disassemble it.
        </p>
      )
    },
    {
