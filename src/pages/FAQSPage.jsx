...
export default function FAQSPage() {
  ...
  const orderingFaqs = [
    ...
    },
    {
      ...
      answer: (
        <p>
          Surely, we do. Diamond Modern Furniture has partnered with several companies to
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            Diamond Modern Furniture has two locations in the Houston area, offering a
    ...
    },
    {
      ...
      icon: '⎔',
      question:
        'Why is Diamond Modern Furniture requesting additional information to fulfill my order?',
      answer: (
        <p>
  ...
  const shippingFaqs = [
    {
      ...
      answer: (
        <>
          <p>Dimond Modern Furniture offers 4 methods of delivery:</p>
          <ul>
            <li>
    ...
    },
    {
      ...
      answer: (
        <p>
            Diamond Modern Furniture will not take your old furniture or disassemble it.
        </p>
      )
    },
    {
