    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <p>In case of loss or damage of shipments en route, after the shipment leaves our warehouse, it is the buyer's responsibility to file a claim against the freight company. In certain cases, Diamond Modern Furniture, at its whole discretion, may choose to arrange a repair service when/where possible and/or applicable. Monetary compensation of any amount will never be an option if insurance or freight liability or repair is a possible remedy of any level or kind.</p>
        ...
        <section className="faqs-intro" aria-label="Delivery Policy intro section">
          <div className="faqs-intro-content">
            ...
            <p className="faqs-subtitle">
              Diamond Modern Furniture provides a variety of delivery options, including Outdoor Drop-Off, Indoor Drop-Off, Room of Choice, White Glove, and Pick-Up.
