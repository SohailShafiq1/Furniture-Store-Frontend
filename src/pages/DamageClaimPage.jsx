        ...
        <section className="damage-claim-form-wrap">
          <form className="damage-claim-form" onSubmit={handleSubmit}>
            ...
            <div className="damage-claim-logo-wrap">
              <img src="/logo.svg" alt="Diamond Modern Furniture" className="damage-claim-logo" />
            </div>
            ...
            <div className="damage-claim-group">
              ...
              <textarea
                ...
                value="By making a purchase from  Diamond Modern Furniture you acknowledge and agree to our delivery and return policy and related conditions."
                readOnly
                rows={4}
              />
              <input
