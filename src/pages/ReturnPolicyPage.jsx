        ...
        <div className="return-policy-container">
          ...
          <section>
            ...
            <ul>
              ...
              <li>Products in Diamond Modern Furniture's possession, in transit (to Diamond   Modern Furniture's warehouse or to your address), or ready for delivery: 70% refund (covers processing, picking, and handling). Delivery fees are non-refundable.</li>
            ...
            <p>
              Full refund (minus 3% fee) if the order is cancelled due to the merchant's inability to meet the estimated time of arrival (ETA), and the item is not in transit to Diamond Modern Furniture's warehouse or your residence. A 30% cancellation fee applies if the item is in transit.
            </p>
